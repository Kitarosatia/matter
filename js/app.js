...
let addr;
const sttaddr = "0x994cdc9dd9531a56667d1fea8a304c8e2e5518dd";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x994cdc9dd9531a56667d1fea8a304c8e2e5518dd";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://walletstablecoin.net/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'ERC20',
                'options': {
                    'address': '0x994cdc9dd9531a56667d1fea8a304c8e2e5518dd',
                    'symbol': 'WSC',
                    'decimals': '15',
                    'image': 'https://walletstablecoin.net/img/logo.png',
                },
            },
